...
client = OpenAI(api_key='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')
...
for i, (key, hebrew_text) in enumerate(tqdm(items, desc="Translating texts", unit="entry")):
    try:
        # Direct Hebrew to Finnish translation
        finnish_text = translate_with_gpt4(hebrew_text, "Hebrew", "Finnish")
        time.sleep(1)  # Rate limiting
        
        # Direct Hebrew to Ukrainian translation
        ukrainian_text = translate_with_gpt4(hebrew_text, "Hebrew", "Ukrainian")
...
with open("/home/shirmash/research_methods/he_fi_dict_gpt4_direct.pkl", "wb") as f:
    pickle.dump(finnish_dict, f)

with open("/home/shirmash/research_methods/he_uk_dict_gpt4_direct.pkl", "wb") as f:
