...
try:
    ...
    with tqdm(total=total_items, desc="Translating to Finnish") as pbar:
        for idx, (key, value) in enumerate(items):
            hebrew_text = value[0]
            
            try:
                # Hebrew to Finnish translation
                finnish_text = translate_text(hebrew_text, "Hebrew", "Finnish")
                ...
                if (idx + 1) % 50 == 0:
                    with open("llama3_translation_checkpoint_fi.pkl", "wb") as f:
    ...
    with open("/home/shirmash/research_methods/translations/he_fi_dict_llama3_direct.pkl", "wb") as f:
        pickle.dump(finnish_dict, f)
