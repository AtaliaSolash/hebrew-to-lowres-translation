...
try:
    ...
    with tqdm(total=total_items, desc="Translating to Ukrainian") as pbar:
        for idx, (key, value) in enumerate(items):
            hebrew_text = value[0]
            
            try:
                # Hebrew to Ukrainian translation
                ukrainian_text = translate_text(hebrew_text, "Hebrew", "Ukrainian")
                ...
                if (idx + 1) % 50 == 0:
                    with open("llama3_translation_checkpoint_uk.pkl", "wb") as f:
    ...
    with open("/home/shirmash/research_methods/translations/he_uk_dict_llama3_direct.pkl", "wb") as f:
        pickle.dump(ukrainian_dict, f)
